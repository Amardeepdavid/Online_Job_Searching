...
import android.view.View.OnClickListener;
	...
	public class Applyjop2 extends Activity  {
		private SQLiteHelper SQLHelper;
		@Override
		protected void onCreate(Bundle savedInstanceState) {
			super.onCreate(savedInstanceState);
			setContentView(R.layout.apply4);
			  SQLHelper = new SQLiteHelper(this); 
			  Button b=(Button)findViewById(R.id.button1);
		TextView cn=(TextView)findViewById(R.id.textView7);	
		TextView el=(TextView)findViewById(R.id.textView8);	
		TextView ex=(TextView)findViewById(R.id.textView11);	
		TextView po=(TextView)findViewById(R.id.textView12);	
		final TextView t=(TextView)findViewById(R.id.textView10);
		TextView sa=(TextView)findViewById(R.id.textView13);	
